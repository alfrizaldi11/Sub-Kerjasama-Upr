...
header("Content-Disposition: attachment; filename=Data kerjasama fisipol.xls");
?>
...
<table>
	...
	$sql = $pdo->prepare("SELECT u.*, k.* FROM kerjasama k LEFT JOIN unit u ON k.`id_unit` = u.`id_unit` WHERE nama_unit='Fakultas Ilmu Sosial dan Ilmu Politik' order by u.nama_unit ASC");
