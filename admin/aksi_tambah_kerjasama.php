...
$query = mysqli_query($koneksi,"INSERT INTO kerjasama (id_unit,institusi_mitra,ruang_lingkup, periode_berlaku, tempo_berlaku, keterangan)
					VALUES ('$nama_unit','$institusi_mitra','$ruang_lingkup','$periode_berlaku','$tempo_berlaku','$keterangan')");
