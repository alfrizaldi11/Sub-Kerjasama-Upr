  ...
  <div class="content-wrapper">
      <section class="content">
        <div class="row">
			...
			<h4><b>Input Album</b></h4>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
								
                                    <form enctype='multipart/form-data' action="aksi_tambah_album.php" method="POST"  >
          ...
          while ($data = mysqli_fetch_array($data_album)) {
				...
				<tr align="center">
                                    ...
                                    <td><center><image src="image/album/
									<?php echo $data['cover']; ?>" style="width: 100px; 
									height: 100px;"></td>
          <td align="center">
                  <div>
                    <a class="btn btn-success" 
                      href="edit_album.php?id=<?php echo $data['id_album'];?>"><i class="fa fa-pencil"></i></a>
                  </div>
