...
header("Content-Disposition: attachment; filename=Data kerjasama fk.xls");
?>
...
<table>
	...
	$sql = $pdo->prepare("SELECT u.*, k.* FROM kerjasama k LEFT JOIN unit u ON k.`id_unit` = u.`id_unit` WHERE nama_unit='Fakultas Kedokteran' order by u.nama_unit ASC");
